...
const plans = [
  {
    ...
    icon: Zap,
    color: "#3B82F6",
    features: ["월 30회 코디 추천", "기본 스타일 분석", "코디 저장 (최대 50개)", "이메일 지원"],
...
export default function Pricing() {
  ...
  return (
    <>
      <SEO
        title="가격 안내 - 뭐입지"
        description="뭐입지의 합리적인 가격 플랜을 확인하세요. 무료 체험 5회 제공!"
        keywords="가격, 요금제, 구독, 무료 체험, 코디 추천 가격"
        url="https://ipzy.vercel.app/pricing"
      />
      <main className="min-h-screen bg-gray-50 text-[#1a1a1a]">
        ...
        <div className="max-w-4xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-12">
            <h1 className="text-3xl font-black mb-4">나에게 맞는 플랜 선택하기</h1>
