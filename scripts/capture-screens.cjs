...
const pages = [
  ...
  { name: '03_Signup', path: '/signup', description: '회원가입 화면' },
  ...
  { name: '10_Error_404', path: '/not-found-page', description: '404 에러 화면' },
  { name: '11_Error_500', path: '/error/500', description: '500 서버 에러 화면' },
  { name: '12_Error_Network', path: '/error/network', description: '네트워크 에러 화면' },
];
